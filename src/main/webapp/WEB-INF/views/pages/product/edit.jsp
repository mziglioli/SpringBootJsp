     	...
     	<div class="grid">
	        <div class="row cells12">
				<div class="input-control text full-size">
					<span class="mif-user prepend-icon"></span> 
					<input value="${entity.category}" id="form-${entityName}-category" type="text" class="form-control" name="category" placeholder="<spring:message code="label.category" />" required maxlength="255">
				</div>
			</div>
		</div>
		<div class="grid">
