	    	...
	    	<div class="row no-margin">
		        <div class="cell colspan6">
					<div class="input-control text full-size">
						<span class="mif-user prepend-icon"></span> 
						<input value="${entity.category}" id="form-${entityName}-category" type="text" class="form-control" name="category" placeholder="<spring:message code="label.category" />"  maxlength="255">
					</div>
				</div>
			</div>
			<div class="row no-margin">
