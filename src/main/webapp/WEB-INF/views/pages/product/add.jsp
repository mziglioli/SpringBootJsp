	        ...
	        <div class="row no-margin">
	        	<div class="cell colspan6">
					<div class="input-control text full-size">
						<input value="${entity.category}" type="text" id="form-${entityName}-category" class="form-control" name="category" placeholder="<spring:message code="label.category" />" required size="200" maxlength="200">
					</div>
				</div>
			</div>
			<div class="row no-margin">
